...
<div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        @endif
                        <div class="card-body">
                             <form action="{{ route('em/edit-designation')}}" method="post" class="user">
                             @csrf
                                <div class="form-group row">
                                    <div class="col-sm-6 offset-3 mb-3 mb-sm-0">
                                        <input type="hidden" class="form-control form-control-user" name="id" value="{{ $designation->id }}">
                                        <input type="text" class="form-control form-control-user" name="name" value="{{ $designation->name }}"
