...
<div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="/hr_yl/public/index.php/payroll/employee-credits/{{ $employee_id }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <div class="card shadow mb-4">
                        ...
                        @endif
                        <div class="card-body">
                             <form action="/hr_yl/public/index.php/payroll/add-employee-credits/{{ $employee_id }}" method="post" class="user">
                             @csrf
                                <div class="form-group row">
                                    <div class="col-sm-6 offset-3 mb-3 mb-sm-0">
                                        ...
                                        <input type="date" required class="form-control form-control-user" name="date" placeholder="Date applied">
                                        <br>
                                        <br>
